    ...
    <body>
        ...
        <div class="page-sidebar">
			...
			<ul class="x-navigation">
				<li class="xn-logo">
					<span style="font-size: 19px; text-align: center; margin: 10px;color:#fff">Arunachal Pradesh State Level</span>
				...
				<li>
					<a style="background-color:#FFC167"><center><span class="xn-text" style="font-family:sans-serif;font-weight:italic;font-size:16px;">Etails</span></center></a>
				</li>
