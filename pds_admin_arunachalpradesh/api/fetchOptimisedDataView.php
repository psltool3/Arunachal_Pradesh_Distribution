...
if (!isset($_POST['district']) || !isset($_POST['tablename']) || !isset($_POST['tablename1'])) {
...
if (!is_string($district) || !is_string($tablename) || !is_string($tablename1)) {
...
if (!preg_match("/^optimiseddata_[0-9]+$/", $tablename) && $tablename !== 'optimised_table') {
     die(json_encode(["error" => "Invalid Table Name"]));
}
if (!preg_match("/^optimiseddata_[0-9]+$/", $tablename1) && $tablename1 !== 'optimised_table') {
     die(json_encode(["error" => "Invalid Table Name 1"]));
}
