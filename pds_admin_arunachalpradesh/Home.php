...
<head>
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Roboto+Condensed:400,300" integrity="sha384-gYHzZDOcr8omFoTy+jwo9cYdJlabU02W7SUO4NyVKkFqCMGJVr2bUwKJ7+i97WQe" crossorigin="anonymous">
</head>
...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Arunachal Pradesh PDS Route Optimization</li>
</ul>
<!-- END BREADCRUMB -->
<div>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					<h1 style="font-weight: bold; color: #335566;">Arunachal Pradesh PDS Route Optimization</h1>
				...
				<div class="col-md-12">
					<div class="panel-body">
						...
						<div id="processingPopup">
							...
							<p id="jobStatusMsg" style="margin-top:20px; font-size:16px; color:#333; font-weight:bold; text-align:center; background:rgba(255,255,255,0.93); padding:8px 18px; border-radius:8px; max-width:440px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">Initializing...</p>
							<p id="jobElapsedMsg" style="display: none;"></p>
...
<script>
	let controller;
	const CG_JOB_KEY = 'cg_job_unique_key_leg2';
	...
	function displayResults(data) {
		...
		cell2.innerHTML = "31";
		cell3.innerHTML = "1,837";
		cell4.innerHTML = "62,606";
		cell5.innerHTML ="44,37,321";
		cell6.innerHTML = "70.88";
